    ...
    <div>
      ...
      >
        ...
        <div class="sidebar-header d-flex justify-content-center align-items-center px-3 py-4">
          <img class="rounded-pill img-fluid" width="160" src={wsLogo} alt="" />
          <div class="ms-2">
            <h5 class="fs-6 mb-0">
              <Link></Link>
            </h5>
        ...
        <div class="search position-relative text-center px-4 py-3 mt-2"></div>

        <ul class="categories list-unstyled">
          <li class="has-dropdown">
            <i class="uil-estate fa-fw"></i>
            <Link style={{ color: "red", fontSize: "22px" }} to="/">
              {" "}
              Admin Dashboard
            </Link>
          </li>
    ...
    <div className={classes.root}>
      <div>
        ...
        <Popper open={open} anchorEl={anchorRef.current} role={undefined} transition disablePortal>
          ...
          <li>
            <div class="ui compact menu" className="ui purple basic button">
          ...
          <li>
            <div class="ui compact menu" className="ui blue basic button">
              <div class="ui simple dropdown item">
                Purchase Management
                <i class="dropdown icon"></i>
                <div class="menu">
          ...
          <li>
            <div class="ui compact menu" className="ui olive basic button">
              <div class="ui simple dropdown item">
                Inventory Management
                <i class="dropdown icon"></i>
                <div class="menu">
                  <div class="item">
                    <Link to="/branchAdd" className="nav-link">
                      Create Branch
                    </Link>
                  </div>
                  <div class="item">
                    <Link to="/branchDetails" className="nav-link">
                      Branch Details
                    </Link>
                  </div>
                </div>
          ...
          <li>
            <div class="ui compact menu" className="ui negative basic button">
              <div class="ui simple dropdown item">
                Contract Management
                <i class="dropdown icon"></i>
                <div class="menu">
                  ...
                  <div class="item">
                    {" "}
                    <Link to="/contractDetails" className="nav-link">
                      Contract Details
                    </Link>
                  </div>
                </div>
            ...
            <div class="container-fluid mx-2">
              <div class="navbar-header">
                ...
                <Link to="/" class="navbar-brand">
                  WS<span class="main-color">Shopping</span>
                </Link>
              </div>
            </div>
          </nav>
        ...
        <div class="p-4">
          <div class="welcome">
            <div class="content rounded-3 p-3">
              <div class="body-bg">{/* <div>{children}</div> */}</div>
            </div>
          </div>
        </div>
      </section>
